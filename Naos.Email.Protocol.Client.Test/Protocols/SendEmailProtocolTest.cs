...
namespace Naos.Email.Protocol.Client.Test
{
    ...
    public static class SendEmailProtocolTest
    {
        ...
        public static void ExecuteAsync___Should_return_SendEmailResponse_with_SendEmailResult_FailedToAddContentToEmail___When_SendEmailRequest_EmailContent_contains_malformed_content()
        {
        }

        [Fact(Skip = "Not sure how to cause this step in the process to throw.")]
        public static void ExecuteAsync___Should_return_SendEmailResponse_with_SendEmailResult_FailedToAddOptionsToEmail___When_SendEmailRequest_EmailOptions_contains_malformed_options()
        {
        }

        [Fact(Skip = "Not sure how to cause this step in the process to throw.")]
        public static void ExecuteAsync___Should_return_SendEmailResponse_with_SendEmailResult_FailedToPackageEmailForSending___When_MailMessage_cannot_be_cast_to_MimeMessage()
        {
        }
        ...
        [Fact(Skip = "Not sure how to cause this step in the process to throw.")]
        public static void ExecuteAsync___Should_return_SendEmailResponse_with_SendEmailResult_FailedToSendEmailToServer___When_server_rejects_email()
        {
        }
    }
}
