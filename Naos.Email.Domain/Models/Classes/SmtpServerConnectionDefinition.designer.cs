    ...
    public partial class SmtpServerConnectionDefinition : IModel<SmtpServerConnectionDefinition>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Host, options, propertyPathTracker, nameof(this.Host));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SecureConnectionMethod, options, propertyPathTracker, nameof(this.SecureConnectionMethod));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
