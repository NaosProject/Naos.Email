...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SmtpServerConnectionDefinition> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SmtpServerConnectionDefinition>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SmtpServerConnectionDefinition> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'host' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "host", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "constructor should throw ArgumentException when parameter 'host' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "host", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'secureConnectionMethod' is SecureConnectionMethod.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>();
                        ...
                        var result = new SmtpServerConnectionDefinition(
                                             ...
                                             referenceObject.Port,
                                             SecureConnectionMethod.Unknown,
                                             referenceObject.Username,
                                             referenceObject.ClearTextPassword);
                    ...
                    ExpectedExceptionMessageContains = new[] { "secureConnectionMethod", "Unknown", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SmtpServerConnectionDefinition>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SmtpServerConnectionDefinition> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "Host should return same 'host' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>();

                        var result = new SystemUnderTestExpectedPropertyValue<SmtpServerConnectionDefinition>
                        {
                            SystemUnderTest = new SmtpServerConnectionDefinition(
                                                      referenceObject.Host,
                                                      referenceObject.Port,
                                                      referenceObject.SecureConnectionMethod,
                                                      referenceObject.Username,
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "SecureConnectionMethod should return same 'secureConnectionMethod' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>();
                    ...
                    PropertyName = "SecureConnectionMethod",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SmtpServerConnectionDefinition>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<SmtpServerConnectionDefinition> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "DeepCloneWithHost should deep clone object and replace Host with the provided host",
                    WithPropertyName = "Host",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SmtpServerConnectionDefinition>();

                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>().ThatIs(_ => !systemUnderTest.Host.IsEqualTo(_.Host));

                        var result = new SystemUnderTestDeepCloneWithValue<SmtpServerConnectionDefinition>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Host,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SmtpServerConnectionDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>().ThatIs(_ => !systemUnderTest.Port.IsEqualTo(_.Port));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "DeepCloneWithSecureConnectionMethod should deep clone object and replace SecureConnectionMethod with the provided secureConnectionMethod",
                    WithPropertyName = "SecureConnectionMethod",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SmtpServerConnectionDefinition>();

                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>().ThatIs(_ => !systemUnderTest.SecureConnectionMethod.IsEqualTo(_.SecureConnectionMethod));

                        var result = new SystemUnderTestDeepCloneWithValue<SmtpServerConnectionDefinition>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.SecureConnectionMethod,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SmtpServerConnectionDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SmtpServerConnectionDefinition>().ThatIs(_ => !systemUnderTest.ClearTextPassword.IsEqualTo(_.ClearTextPassword));
        ...
        private static readonly SmtpServerConnectionDefinition ReferenceObjectForEquatableTestScenarios = A.Dummy<SmtpServerConnectionDefinition>();

        private static readonly EquatableTestScenarios<SmtpServerConnectionDefinition> EquatableTestScenarios = new EquatableTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new EquatableTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SmtpServerConnectionDefinition[]
                    {
        ...
        private static readonly ValidModelTestScenarios<SmtpServerConnectionDefinition> ValidModelTestScenarios = new ValidModelTestScenarios<SmtpServerConnectionDefinition>()
            .AddScenario(() =>
                new ValidModelTestScenario<SmtpServerConnectionDefinition>
                {
                    Name = "a dummy SmtpServerConnectionDefinition should be valid",
                    SystemUnderTest = A.Dummy<SmtpServerConnectionDefinition>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SmtpServerConnectionDefinition___Should_implement_IModel_of_SmtpServerConnectionDefinition___When_reflecting()
            {
                // Arrange
                var type = typeof(SmtpServerConnectionDefinition);

                var expectedModelMethods = typeof(IModel<SmtpServerConnectionDefinition>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SmtpServerConnectionDefinition>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SmtpServerConnectionDefinition___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SmtpServerConnectionDefinition);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SmtpServerConnectionDefinition)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SmtpServerConnectionDefinition)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SmtpServerConnectionDefinition).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SmtpServerConnectionDefinition>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SmtpServerConnectionDefinition systemUnderTest1 = null;
                SmtpServerConnectionDefinition systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SmtpServerConnectionDefinition systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SmtpServerConnectionDefinition___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SmtpServerConnectionDefinition___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SmtpServerConnectionDefinition___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SmtpServerConnectionDefinition___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SmtpServerConnectionDefinition___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
