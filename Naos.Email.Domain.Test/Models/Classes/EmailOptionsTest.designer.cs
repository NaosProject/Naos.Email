...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<EmailOptions> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<EmailOptions>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<EmailOptions>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EmailOptions>();

                        var result = new SystemUnderTestExpectedStringRepresentation<EmailOptions>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Email.Domain.EmailOptions: Priority = {systemUnderTest.Priority?.ToString() ?? "<null>"}, DeliveryNotification = {systemUnderTest.DeliveryNotification?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<EmailOptions> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<EmailOptions>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<EmailOptions> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<EmailOptions>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EmailOptions>
                {
                    Name = "Priority should return same 'priority' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<EmailOptions>();

                        var result = new SystemUnderTestExpectedPropertyValue<EmailOptions>
                        {
                            SystemUnderTest = new EmailOptions(
                                                      referenceObject.Priority,
                                                      referenceObject.DeliveryNotification),
                            ExpectedPropertyValue = referenceObject.Priority,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EmailOptions>
                {
                    Name = "DeliveryNotification should return same 'deliveryNotification' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<EmailOptions>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<EmailOptions>
                        {
                            SystemUnderTest = new EmailOptions(
                                                      referenceObject.Priority,
                                                      referenceObject.DeliveryNotification),
                            ExpectedPropertyValue = referenceObject.DeliveryNotification,
                        };

                        return result;
                    },
                    PropertyName = "DeliveryNotification",
                });

        private static readonly DeepCloneWithTestScenarios<EmailOptions> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<EmailOptions>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailOptions>
                {
                    Name = "DeepCloneWithPriority should deep clone object and replace Priority with the provided priority",
                    WithPropertyName = "Priority",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EmailOptions>();

                        var referenceObject = A.Dummy<EmailOptions>().ThatIs(_ => !systemUnderTest.Priority.IsEqualTo(_.Priority));

                        var result = new SystemUnderTestDeepCloneWithValue<EmailOptions>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Priority,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailOptions>
                {
                    Name = "DeepCloneWithDeliveryNotification should deep clone object and replace DeliveryNotification with the provided deliveryNotification",
                    WithPropertyName = "DeliveryNotification",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EmailOptions>();

                        var referenceObject = A.Dummy<EmailOptions>().ThatIs(_ => !systemUnderTest.DeliveryNotification.IsEqualTo(_.DeliveryNotification));

                        var result = new SystemUnderTestDeepCloneWithValue<EmailOptions>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.DeliveryNotification,
                        };
        ...
        private static readonly EmailOptions ReferenceObjectForEquatableTestScenarios = A.Dummy<EmailOptions>();

        private static readonly EquatableTestScenarios<EmailOptions> EquatableTestScenarios = new EquatableTestScenarios<EmailOptions>()
            .AddScenario(() =>
                new EquatableTestScenario<EmailOptions>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EmailOptions[]
                    {
                        new EmailOptions(
                                ReferenceObjectForEquatableTestScenarios.Priority,
                                ReferenceObjectForEquatableTestScenarios.DeliveryNotification),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EmailOptions[]
                    {
                        new EmailOptions(
                                A.Dummy<EmailOptions>().Whose(_ => !_.Priority.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Priority)).Priority,
                                ReferenceObjectForEquatableTestScenarios.DeliveryNotification),
                        new EmailOptions(
                                ReferenceObjectForEquatableTestScenarios.Priority,
                                A.Dummy<EmailOptions>().Whose(_ => !_.DeliveryNotification.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DeliveryNotification)).DeliveryNotification),
                    },
        ...
        private static readonly ValidModelTestScenarios<EmailOptions> ValidModelTestScenarios = new ValidModelTestScenarios<EmailOptions>()
            .AddScenario(() =>
                new ValidModelTestScenario<EmailOptions>
                {
                    Name = "a dummy EmailOptions should be valid",
                    SystemUnderTest = A.Dummy<EmailOptions>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void EmailOptions___Should_implement_IModel_of_EmailOptions___When_reflecting()
            {
                // Arrange
                var type = typeof(EmailOptions);

                var expectedModelMethods = typeof(IModel<EmailOptions>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EmailOptions>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EmailOptions___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EmailOptions);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (EmailOptions)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Priority", "DeliveryNotification" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (EmailOptions)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(EmailOptions).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EmailOptions>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                EmailOptions systemUnderTest1 = null;
                EmailOptions systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    EmailOptions systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailOptions___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailOptions___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailOptions___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailOptions___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailOptions___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
