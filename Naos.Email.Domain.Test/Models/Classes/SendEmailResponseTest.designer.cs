    ...
    public static partial class SendEmailResponseTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SendEmailResponse> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SendEmailResponse>()
            .AddScenario(() =>
                ...
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'sendEmailResult' is SendEmailResult.Unknown",
                    ConstructionFunc = () =>
                    {
        ...
        private static readonly ValidModelTestScenarios<SendEmailResponse> ValidModelTestScenarios = new ValidModelTestScenarios<SendEmailResponse>()
            .AddScenario(() =>
                new ValidModelTestScenario<SendEmailResponse>
                {
                    Name = "a dummy SendEmailResponse should be valid",
                    SystemUnderTest = A.Dummy<SendEmailResponse>(),
                });
