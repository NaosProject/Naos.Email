...
namespace Naos.Email.Domain.Test
{
    ...
    public static partial class EmailParticipantsTest
    {
        ...
        private static readonly ValidModelTestScenarios<EmailParticipants> ValidModelTestScenarios = new ValidModelTestScenarios<EmailParticipants>()
            .AddScenario(() =>
                new ValidModelTestScenario<EmailParticipants>
                {
                    Name = "a dummy EmailParticipants should be valid",
                    SystemUnderTest = A.Dummy<EmailParticipants>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.From.GetType().IsValueType)
                {
                ...
                else if (!actual.To.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                ...
                else if (!actual.Cc.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                ...
                else if (!actual.Bcc.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                ...
                else if (!actual.ReplyTo.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
