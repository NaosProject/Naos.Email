...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SendEmailRequest> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SendEmailRequest>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SendEmailRequest>();

                        var result = new SystemUnderTestExpectedStringRepresentation<SendEmailRequest>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Email.Domain.SendEmailRequest: EmailParticipants = {systemUnderTest.EmailParticipants?.ToString() ?? "<null>"}, EmailContent = {systemUnderTest.EmailContent?.ToString() ?? "<null>"}, EmailOptions = {systemUnderTest.EmailOptions?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SendEmailRequest> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SendEmailRequest> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SendEmailRequest>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<SendEmailRequest>
                        {
                            SystemUnderTest = new SendEmailRequest(
                                                      referenceObject.EmailParticipants,
                                                      referenceObject.EmailContent,
                                                      referenceObject.EmailOptions),
        ...
        private static readonly DeepCloneWithTestScenarios<SendEmailRequest> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SendEmailRequest>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SendEmailRequest>().ThatIs(_ => !systemUnderTest.EmailParticipants.IsEqualTo(_.EmailParticipants));

                        var result = new SystemUnderTestDeepCloneWithValue<SendEmailRequest>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SendEmailRequest>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SendEmailRequest>().ThatIs(_ => !systemUnderTest.EmailContent.IsEqualTo(_.EmailContent));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SendEmailRequest>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SendEmailRequest>().ThatIs(_ => !systemUnderTest.EmailOptions.IsEqualTo(_.EmailOptions));
        ...
        private static readonly SendEmailRequest ReferenceObjectForEquatableTestScenarios = A.Dummy<SendEmailRequest>();

        private static readonly EquatableTestScenarios<SendEmailRequest> EquatableTestScenarios = new EquatableTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
                new EquatableTestScenario<SendEmailRequest>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SendEmailRequest[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new SendEmailRequest[]
                    {
                        new SendEmailRequest(
                                A.Dummy<SendEmailRequest>().Whose(_ => !_.EmailParticipants.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EmailParticipants)).EmailParticipants,
                                ReferenceObjectForEquatableTestScenarios.EmailContent,
                                ReferenceObjectForEquatableTestScenarios.EmailOptions),
                        new SendEmailRequest(
                                ReferenceObjectForEquatableTestScenarios.EmailParticipants,
                                A.Dummy<SendEmailRequest>().Whose(_ => !_.EmailContent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EmailContent)).EmailContent,
                                ReferenceObjectForEquatableTestScenarios.EmailOptions),
                        new SendEmailRequest(
                                ReferenceObjectForEquatableTestScenarios.EmailParticipants,
                                ReferenceObjectForEquatableTestScenarios.EmailContent,
                                A.Dummy<SendEmailRequest>().Whose(_ => !_.EmailOptions.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EmailOptions)).EmailOptions),
                    },
        ...
        private static readonly ValidModelTestScenarios<SendEmailRequest> ValidModelTestScenarios = new ValidModelTestScenarios<SendEmailRequest>()
            .AddScenario(() =>
                new ValidModelTestScenario<SendEmailRequest>
                {
                    Name = "a dummy SendEmailRequest should be valid",
                    SystemUnderTest = A.Dummy<SendEmailRequest>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SendEmailRequest___Should_implement_IModel_of_SendEmailRequest___When_reflecting()
            {
                // Arrange
                var type = typeof(SendEmailRequest);

                var expectedModelMethods = typeof(IModel<SendEmailRequest>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SendEmailRequest>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SendEmailRequest___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SendEmailRequest);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SendEmailRequest)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.EmailParticipants.GetType().IsValueType)
                {
                ...
                else if (!actual.EmailContent.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                ...
                else if (!actual.EmailOptions.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SendEmailRequest)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SendEmailRequest).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SendEmailRequest>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SendEmailRequest systemUnderTest1 = null;
                SendEmailRequest systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SendEmailRequest systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SendEmailRequest___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SendEmailRequest___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SendEmailRequest___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SendEmailRequest___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SendEmailRequest___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
