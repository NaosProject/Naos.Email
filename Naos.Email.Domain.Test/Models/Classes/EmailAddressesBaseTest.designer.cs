...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly EmailAddressesBase ReferenceObjectForEquatableTestScenarios = A.Dummy<EmailAddressesBase>();

        private static readonly EquatableTestScenarios<EmailAddressesBase> EquatableTestScenarios = new EquatableTestScenarios<EmailAddressesBase>()
            .AddScenario(() =>
                new EquatableTestScenario<EmailAddressesBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EmailAddressesBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EmailAddressesBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithFrom(A.Dummy<EmailAddressesBase>().Whose(_ => !_.From.IsEqualTo(ReferenceObjectForEquatableTestScenarios.From)).From),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithTo(A.Dummy<EmailAddressesBase>().Whose(_ => !_.To.IsEqualTo(ReferenceObjectForEquatableTestScenarios.To)).To),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithCc(A.Dummy<EmailAddressesBase>().Whose(_ => !_.Cc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Cc)).Cc),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithBcc(A.Dummy<EmailAddressesBase>().Whose(_ => !_.Bcc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Bcc)).Bcc),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithReplyTo(A.Dummy<EmailAddressesBase>().Whose(_ => !_.ReplyTo.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ReplyTo)).ReplyTo),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new EmailAddressesBase[]
                    {
                        A.Dummy<EmailAddressesBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EmailAddressesBase___Should_implement_IModel_of_EmailAddressesBase___When_reflecting()
            {
                // Arrange
                var type = typeof(EmailAddressesBase);

                var expectedModelMethods = typeof(IModel<EmailAddressesBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EmailAddressesBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EmailAddressesBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EmailAddressesBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<EmailAddressesBase>();

                // Act
                var actual = (EmailAddressesBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EmailAddressesBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EmailAddressesBase systemUnderTest1 = null;
                EmailAddressesBase systemUnderTest2 = null;
