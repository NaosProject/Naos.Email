...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<EmailResponse> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<EmailResponse>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<EmailResponse>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<EmailResponse>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Email.Domain.EmailResponse: SendEmailResult = {systemUnderTest.SendEmailResult.ToString() ?? "<null>"}, ExceptionToString = {systemUnderTest.ExceptionToString?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, CommunicationLog = {systemUnderTest.CommunicationLog?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<EmailResponse> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<EmailResponse>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<EmailResponse> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<EmailResponse>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EmailResponse>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<EmailResponse>
                        {
                            SystemUnderTest = new EmailResponse(
                                                      referenceObject.SendEmailResult,
                                                      referenceObject.ExceptionToString,
                                                      referenceObject.CommunicationLog),
        ...
        private static readonly DeepCloneWithTestScenarios<EmailResponse> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<EmailResponse>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailResponse>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EmailResponse>().ThatIs(_ => !systemUnderTest.SendEmailResult.IsEqualTo(_.SendEmailResult));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailResponse>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EmailResponse>().ThatIs(_ => !systemUnderTest.ExceptionToString.IsEqualTo(_.ExceptionToString));
        ...
        private static readonly EmailResponse ReferenceObjectForEquatableTestScenarios = A.Dummy<EmailResponse>();

        private static readonly EquatableTestScenarios<EmailResponse> EquatableTestScenarios = new EquatableTestScenarios<EmailResponse>()
            .AddScenario(() =>
                new EquatableTestScenario<EmailResponse>
                {
                    ...
                    {
                        new EmailResponse(
                                A.Dummy<EmailResponse>().Whose(_ => !_.SendEmailResult.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SendEmailResult)).SendEmailResult,
                                ReferenceObjectForEquatableTestScenarios.ExceptionToString,
                                ReferenceObjectForEquatableTestScenarios.CommunicationLog),
                        new EmailResponse(
                                ReferenceObjectForEquatableTestScenarios.SendEmailResult,
                                A.Dummy<EmailResponse>().Whose(_ => !_.ExceptionToString.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExceptionToString)).ExceptionToString,
                                ReferenceObjectForEquatableTestScenarios.CommunicationLog),
                        new EmailResponse(
                                ReferenceObjectForEquatableTestScenarios.SendEmailResult,
                                ReferenceObjectForEquatableTestScenarios.ExceptionToString,
        ...
        public static class Structural
        {
            ...
            public static void EmailResponse___Should_implement_IModel_of_EmailResponse___When_reflecting()
            {
                // Arrange
                var type = typeof(EmailResponse);

                var expectedModelMethods = typeof(IModel<EmailResponse>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EmailResponse>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EmailResponse___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EmailResponse);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (EmailResponse)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (EmailResponse)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(EmailResponse).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EmailResponse>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EmailResponse systemUnderTest1 = null;
                EmailResponse systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    EmailResponse systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailResponse___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailResponse___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailResponse___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailResponse___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailResponse___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
