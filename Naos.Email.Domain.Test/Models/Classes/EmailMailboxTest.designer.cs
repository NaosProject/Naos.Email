...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<EmailMailbox> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<EmailMailbox>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<EmailMailbox>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EmailMailbox>();

                        var result = new SystemUnderTestExpectedStringRepresentation<EmailMailbox>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Email.Domain.EmailMailbox: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Address = {systemUnderTest.Address?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<EmailMailbox> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<EmailMailbox>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<EmailMailbox> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<EmailMailbox>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EmailMailbox>
                {
                    Name = "Address should return same 'address' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<EmailMailbox>();

                        var result = new SystemUnderTestExpectedPropertyValue<EmailMailbox>
                        {
                            SystemUnderTest = new EmailMailbox(
                                                      referenceObject.Address,
                                                      referenceObject.Name),
                            ExpectedPropertyValue = referenceObject.Address,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<EmailMailbox> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<EmailMailbox>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailMailbox>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EmailMailbox>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<EmailMailbox>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EmailMailbox>
                {
                    Name = "DeepCloneWithAddress should deep clone object and replace Address with the provided address",
                    WithPropertyName = "Address",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EmailMailbox>();

                        var referenceObject = A.Dummy<EmailMailbox>().ThatIs(_ => !systemUnderTest.Address.IsEqualTo(_.Address));

                        var result = new SystemUnderTestDeepCloneWithValue<EmailMailbox>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Address,
                        };
        ...
        private static readonly EmailMailbox ReferenceObjectForEquatableTestScenarios = A.Dummy<EmailMailbox>();

        private static readonly EquatableTestScenarios<EmailMailbox> EquatableTestScenarios = new EquatableTestScenarios<EmailMailbox>()
            .AddScenario(() =>
                new EquatableTestScenario<EmailMailbox>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EmailMailbox[]
                    {
                        new EmailMailbox(
                                ReferenceObjectForEquatableTestScenarios.Address,
                                ReferenceObjectForEquatableTestScenarios.Name),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EmailMailbox[]
                    {
                        new EmailMailbox(
                                ReferenceObjectForEquatableTestScenarios.Address,
                                A.Dummy<EmailMailbox>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                        new EmailMailbox(
                                A.Dummy<EmailMailbox>().Whose(_ => !_.Address.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Address)).Address,
                                ReferenceObjectForEquatableTestScenarios.Name),
                    },
        ...
        private static readonly ValidModelTestScenarios<EmailMailbox> ValidModelTestScenarios = new ValidModelTestScenarios<EmailMailbox>()
            .AddScenario(() =>
                new ValidModelTestScenario<EmailMailbox>
                {
                    Name = "a dummy EmailMailbox should be valid",
                    SystemUnderTest = A.Dummy<EmailMailbox>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void EmailMailbox___Should_implement_IModel_of_EmailMailbox___When_reflecting()
            {
                // Arrange
                var type = typeof(EmailMailbox);

                var expectedModelMethods = typeof(IModel<EmailMailbox>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EmailMailbox>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EmailMailbox___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EmailMailbox);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (EmailMailbox)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Name", "Address" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (EmailMailbox)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(EmailMailbox).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EmailMailbox>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                EmailMailbox systemUnderTest1 = null;
                EmailMailbox systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    EmailMailbox systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailMailbox___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailMailbox___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailMailbox___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailMailbox___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EmailMailbox___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
