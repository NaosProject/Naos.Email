...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly SendEmailResponseEventBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<SendEmailResponseEventBase<Version>>();

        private static readonly EquatableTestScenarios<SendEmailResponseEventBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<SendEmailResponseEventBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<SendEmailResponseEventBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SendEmailResponseEventBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SendEmailResponseEventBase<Version>[]
                    {
                        ...
                        // (SendEmailResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<SendEmailResponseEventBase<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // (SendEmailResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<SendEmailResponseEventBase<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithSendEmailResponse(A.Dummy<SendEmailResponseEventBase<Version>>().Whose(_ => !_.SendEmailResponse.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SendEmailResponse)).SendEmailResponse),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new SendEmailResponseEventBase<Version>[]
                    {
                        A.Dummy<SendEmailResponseEventBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void SendEmailResponseEventBase_of_Version___Should_implement_IModel_of_SendEmailResponseEventBase_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(SendEmailResponseEventBase<Version>);

                var expectedModelMethods = typeof(IModel<SendEmailResponseEventBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SendEmailResponseEventBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SendEmailResponseEventBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SendEmailResponseEventBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<SendEmailResponseEventBase<Version>>();

                // Act
                var actual = (SendEmailResponseEventBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SendEmailResponseEventBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                SendEmailResponseEventBase<Version> systemUnderTest1 = null;
                SendEmailResponseEventBase<Version> systemUnderTest2 = null;
