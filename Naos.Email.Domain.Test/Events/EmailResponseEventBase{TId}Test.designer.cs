...
namespace Naos.Email.Domain.Test
{
    ...
    {
        private static readonly EmailResponseEventBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<EmailResponseEventBase<Version>>();

        private static readonly EquatableTestScenarios<EmailResponseEventBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<EmailResponseEventBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<EmailResponseEventBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EmailResponseEventBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EmailResponseEventBase<Version>[]
                    {
                        ...
                        // (EmailResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<EmailResponseEventBase<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // (EmailResponseEventBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<EmailResponseEventBase<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithEmailResponse(A.Dummy<EmailResponseEventBase<Version>>().Whose(_ => !_.EmailResponse.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EmailResponse)).EmailResponse),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new EmailResponseEventBase<Version>[]
                    {
                        A.Dummy<EmailResponseEventBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EmailResponseEventBase___Should_implement_IModel_of_EmailResponseEventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(EmailResponseEventBase<Version>);

                var expectedModelMethods = typeof(IModel<EmailResponseEventBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EmailResponseEventBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EmailResponseEventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EmailResponseEventBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<EmailResponseEventBase<Version>>();

                // Act
                var actual = (EmailResponseEventBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EmailResponseEventBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EmailResponseEventBase<Version> systemUnderTest1 = null;
                EmailResponseEventBase<Version> systemUnderTest2 = null;
